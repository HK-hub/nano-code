...
Shutdown protocol and plan approval protocol, both using request_id
correlation pattern. Builds on s09's team messaging.
...
class TeammateManager:
    ...
    def _teammate_loop(self, name: str, role: str, prompt: str):
        sys_prompt = (
            ...
            f"Respond to shutdown_request with shutdown response."
