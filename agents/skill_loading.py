...
Tow-layer skill injection avoid bloating the system prompt.

    Layer 1 (cheap): skill names in system prompt (~100 tokens/skill)
    Layer 2 (demand): full skill body in tool_result
...
Key Insight: "Don't put everything in the system prompty. Load on demand."
"""
...
Use load_skill to access specialized knowledge before tracking unfamiliar topics.
